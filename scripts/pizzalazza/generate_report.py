#!/usr/bin/env python3
"""
Pizza Lazza CrowdStrike Weekly Health Check Report
...
# ── CONFIG ──────────────────────────────────────────────────
CLIENT_ID  = "dbec0850f9144386bfb5bdad5861e71f"
SECRET     = "tKz4YPfmQB3r08FRAaS6CvT5ldw9e2GIEgH1Ls7y"
BASE_URL   = "https://api.eu-1.crowdstrike.com"
OUTPUT_DIR = "/home/infosec/.openclaw/workspace/customers/reports/pizzalazza"
...
def main():
    ...
    for i, (label, value) in enumerate([
        ...
        ("Prepared by", "Pure7"), ("Customer", "Pizza Lazza"),
    ...
    ws_sum["A1"] = "Pizza Lazza – CrowdStrike Security Dashboard"
    ...
    ws_risk["A1"] = "Pizza Lazza – Risk & Action Required"
    ...
    ws_hosts["A1"] = f"Pizza Lazza – CrowdStrike Host Inventory  ({len(hosts)} hosts)"
    ...
    ws1["A1"] = "Pizza Lazza – CrowdStrike Host Grupları"
    ...
    ws2["A1"] = "Pizza Lazza – Host Grubu / Policy Atamaları"
    ...
    ws3["A1"] = "Pizza Lazza – CrowdStrike Policy Details"
    ...
    ws_excl["A1"] = f"Pizza Lazza – CrowdStrike Exclusions  ({len(ml_details)+len(ioa_details)+len(sv_details)} total)"
    ...
    ws_ua["A1"] = f"Pizza Lazza – Unmanaged Assets  ({len(ua_filtered)} assets)"
    ...
    ws_hm["A1"] = f"Pizza Lazza – High Memory Usage (>80%)  ({len(hm_hosts)} hosts)"
    ...
    # ── KAYDET ──────────────────────────────────────────────
    filename = f"Pizza_Lazza_CrowdStrike_HealthCheck_{date_str}.xlsx"
